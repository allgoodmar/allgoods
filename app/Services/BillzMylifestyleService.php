...
class BillzMylifestyleService {
    ...
    public function generateToken()
    {
        ...
        */
        $token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJteWxpZmVzdHlsZWUudXoiLCJpYXQiOjE2NTY1ODgwMzgsImV4cCI6MTY4ODEwNjAzOCwic3ViIjoibWxzLmFsbGdvb2RzIn0.wKBJLEdX8J8F9IDT-VwmEh5ncJbyEBRR23onVu_k56M";
        return $token;
